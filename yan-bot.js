...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6282158277341:+6282158277341\n'  
            + 'END:VCARD' 
...
const ownerNumber = ["6282158277341@s.whatsapp.net"]  
		...
		try {
			...
			if (anu.action == 'add') {
				num = anu.participants[0]
					pp_user = 'https://www.mediafire.com/download/0d4clcwovbwhpjk'
				teks = `
Hallo - (●’◡’●)ﾉ
@${num.split('@')[0]}
	...
	break
		...
		if (isBanned) return reply(ind.baned())
                reply('Siap spam 1x')
                                       ...
                                       if (args[0].startsWith('82158277341')) return reply('Gagal tidak dapat spam nomor bot')
                                       if (args[0].startsWith('8995618868')) return reply('Gagal tidak dapat spam nomor owner')
...
break
		...
		case 'daftar':
                ...
                pp_user = await getBuffer(`http://1.bp.blogspot.com/-kvBckk4QKSY/Vf_9ARIuzJI/AAAAAAAACOM/nWViiljHCug/s1600/icon.jpg`)
                veri = sender
                if (isGroup) {
                    ...
                    reply('Berhasil melakukan pendaftaran sekarang datamu sudah masuk ke database yan-bot')
		    addATM(sender)
