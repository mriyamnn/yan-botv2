...
const wait = async (media) => new Promise(async (resolve, reject) => {
    ...
    try {
    	...
    	let belief = () => similarity < 0.89 ? "Iyan memiliki keyakinan rendah dalam hal ini : " : ""
...
~> Season  : *${season}*`});
		...
		console.log(e)
		reject(`Maaf sayang iyan gk tau anime ini`)
	}
})
...
const simih = async (text) => {
	try {
		...
		return 'Simi apa tuh iyan gk tau sayang hehehe'
	}
}
